package com.movile.next.tvON.database.manual.provider;
...
import com.movile.next.tvON.database.manual.tvONDbHelper;
import com.movile.next.tvON.database.manual.helper.ProviderUriHelper;

public class tvONContentProvider extends ContentProvider{
    private tvONDbHelper mDbHelper;
    private ProviderUriHelper mUriHelper;

    @Override
    public boolean onCreate() {
        mDbHelper = new tvONDbHelper(getContext());
